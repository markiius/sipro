  ...
  background-image: url('<?= base_url() ?>logm/<?= $municipio->membrete ?>');">
    ...
    <table class="text-norm" style="font-size:10px">
        <tr>
            ...
            <td class="bord" style="width:210px; height:15px;">
    ...
    <br>
    <!-- <div class="text-align-center-color">
        OBRAS REGISTRADAS
    </div> -->
    <div>
        <table class="default text-tit">
            <tr class="text-norm">
                ...
                <th class="bord" bgcolor="#595D64" style="color:#FFFFFF">Folio MIDS</th>
                ...
                <th class="bord" bgcolor="#595D64" style="width:10px; color:#FFFFFF">Rubro</th>
                ...
                <th class="bord" bgcolor="#595D64" style="color:#FFFFFF">Grado de Margin.</th>
                <th class="bord" bgcolor="#595D64" style="color:#FFFFFF">Criterios de Asignación</th>
                <th class="bord" bgcolor="#595D64" style="color:#FFFFFF">Indicadores de Vivienda</th>
                ...
                <th class="bord" bgcolor="#595D64" style="color:#FFFFFF">Avance finan.</th>
                <th class="bord" bgcolor="#595D64" style="color:#FFFFFF">Avance fisico</th>
                <!-- <th class="bord" bgcolor="#595D64" style="width:60px; color:#FFFFFF">Geo.</th> -->
            </tr>
            <tbody>
                <?php
                $id = "";
                foreach ($obras as $key => $value) : ?>
                    <tr>
                        ...
                        <td class="bord text-norm" align="center"><?= $value->nombre_criterio ?></td>
                        <td class="bord text-norm" align="center"><?= $value->nombre_indicador ?></td>
