                    ...
                    <div id="parte_1">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="nombre_municipio" name="nombre_municipio" value="<?= $nombreMunicipio ?>" required>
                                <div class="invalid-feedback">
                    ...
                    <div id="parte_3">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="fuente_financiamiento" name="fuente_financiamiento" value="FISM" required>
                                <div class="invalid-feedback">
                                    Fuente requerida
                                </div>
                            </div>
...
<script>
    ...
    $('#btnGuardarInformacionAnaliticoF').on('click', function() {

        guardarAnaliticoF();
        location.reload();
    });

    function guardarAnaliticoF() {
