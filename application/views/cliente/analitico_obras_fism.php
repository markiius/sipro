                ...
                <div id="sihayinfo">
                    ...
                    <div class="row">
                        <div class="col col-12 pull-right" style="font-family: 'Heebo', sans-serif; ">
                            ...
                            TECHO FINANCIERO DE FISM ACUMULADO: <span style="font-weight: bold; text-emphasis-color: black; color:black">$ <?= number_format($acum, 2) ?></span>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 ">
            ...
            <a id="nuevoAnalitico" href="#" class="btn btn-success btn-sm btn-icon-split">
                ...
                <span class="text">Registrar Obra</span>
            </a>
            <div class="row justify-content-end">
                <a href="">Recargar datos<i class="fas fa-sync-alt"></i></a>
            </div>
        </div>
                        ...
                        <?php if ($obras) {
                            ...
                            foreach ($obras as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td><?= $value->id_criterio ?></td>
                                    <td><?= $value->id_indicador ?></td>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-anaitico-fism" class="needs-validation" novalidate>
                    <div id="parte_1">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="validationCustom01" class="form-label">EJERCICIO FISCAL</label>
                                <input type="text" class="form-control" id="ejercicio_fiscal" name="ejercicio_fiscal" value="2022" readonly required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="nombre_entidad" name="nombre_entidad" value="PUEBLA" readonly required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="clave_entidad" name="clave_entidad" value="21" readonly required>
                                <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="nombre_municipio" name="nombre_municipio" value="<?= $nombreMunicipio ?>" readonly required>
                                <div class="invalid-feedback">
                    ...
                    <div id="parte_3">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="poblacion_carencia" name="poblacion_carencia" required>
                                <div class="invalid-feedback">
                                    Numero requerido
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="total_poblacion_carencia" name="total_poblacion_carencia" required>
                                <div class="invalid-feedback">
                                    Numero requerido
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="fuente_financiamiento" name="fuente_financiamiento" value="FISM" readonly required>
                                <div class="invalid-feedback">
                                    Fuente requerida
                                </div>
                            </div>
                        ...
                        <br>
                        <div class="row justify-content-end">
                            <button id="btnGuardarInformacionAnaliticoF" href="#" class="btn btn-success btn-sm btn-icon-split" type="submit">
                                <span class="icon text-white-50">
                ...
                <form id="form-anaitico-fism-update" class="needs-validation" novalidate>
                    ...
                    <div id="parte_3">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label for="validationCustom01" class="form-label">FUENTE DE FINANCIAMIENTO</label>
                                <input type="text" class="form-control" id="fuente_financiamiento_m" name="fuente_financiamiento" value="FISM" readonly required>
                                <div class="invalid-feedback">
                                    Fuente requerida
                                </div>
                            </div>
...
<script>
    ...
    $('#cerrarModalNew').on('click', function() {
        $("#form-anaitico-fism")[0].reset();
        $('#modalAnalitico').modal('hide');

    });

    $('#btnGuardarInformacionAnaliticoF').on('click', function(e) {
        e.preventDefault();
        var data = $('#form-anaitico-fism').serialize();
        ...
        var clave_municipio = $("#clave_municipio").val();
        var nombre_localidad = $("#nombre_localidad").val();
        var clave_localidad = $("#clave_localidad").val();
        var numero_obra = $("#numero_obra").val();
        var folio_mids = $("#folio_mids").val();
        var ubicacion_obra = $("#ubicacion_obra").val();
        var tipo_localidad = $("#tipo_localidad").val();
        var rubro_accion = $("#rubro_accion").val();
        var poblacion_total = $("#poblacion_total").val();
        var poblacion_referencia = $("#poblacion_referencia").val();
        var poblacion_objetivo = $("#poblacion_objetivo").val();
        var poblacion_atendida = $("#poblacion_atendida").val();
        var numero_hombres = $("#numero_hombres").val();
        var numero_mujeres = $("#numero_mujeres").val();
        var grado_marginacion = $("#grado_marginacion").val();
        var criterios_asignacion = $("#criterios_asignacion").val();
        var indicadores_vivienda = $("#indicadores_vivienda").val();
        var poblacion_carencia = $("#poblacion_carencia").val();
        var total_poblacion_carencia = $("#total_poblacion_carencia").val();
        var monto_obra = $("#monto_obra").val();
        var fuente_financiamiento = $("#fuente_financiamiento").val();
        var avance_financiero = $("#avance_financiero").val();
        var avance_fisico = $("#avance_fisico").val();
        var geo_localizacion = $("#geo_localizacion").val();


        if (ejercicio_fiscal != "" && nombre_entidad != "" && clave_entidad != "" && nombre_municipio != "" && clave_municipio != "" && nombre_localidad != null &&
            clave_localidad != "" && numero_obra != "" && folio_mids != "" && ubicacion_obra != "" && tipo_localidad != null && rubro_accion != null && poblacion_total != "" &&
            poblacion_referencia != "" && poblacion_objetivo != "" && poblacion_atendida != "" && numero_hombres != "" && numero_mujeres != "" && grado_marginacion != "" &&
            criterios_asignacion != null && indicadores_vivienda != null && poblacion_carencia != "" && total_poblacion_carencia != "" && monto_obra != "" && fuente_financiamiento != "" &&
            avance_financiero != "" && avance_fisico != "" && geo_localizacion != "") {
            //alert("la informacion esta llena puede almacenar en la bd  "+tipo_localidad);
            $.ajax({
                method: "post",
                url: "<?= base_url() ?>Nuevo/Analitico/Fism",
                data: data,
                beforeSend: function() {
            ...
            mensaje("warning", "Campos incompletos", "Por favor llenar toda la informacion solicitada!");
        }
